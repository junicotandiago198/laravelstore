...
<div class="page-dashboard">
    ...
    <div class="sidebar-heading text-center">
        <img src="/images/dashbooard-store-logo.svg" class="my-4" alt="" />
        </div>
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav d-none d-lg-flex ml-auto">
                ...
                <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown"> <img src="/images/icon-user.png" alt="" class="rounded-circle mr-2 profile-picture" /> Hi, {{ Auth::user()->name }} </a>
