...
<div class="page-dashboard">
    ...
    <div class="border-right" id="sidebar-wrapper">
        ...
        <img src="/images/admin-logo.png" class="my-4" style="max-width: 120px" alt="" />
        </div>
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav d-none d-lg-flex ml-auto">
                ...
                <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown"> <img src="/images/icon-user.png" alt="" class="rounded-circle mr-2 profile-picture" /> Hi, Junico </a>
            ...
            <ul class="navbar-nav d-block d-lg-none">
                <li class="nav-item">
                <a href="#" class="nav-link">Hi, Junico</a>
                </li>
                <li class="nav-item">
